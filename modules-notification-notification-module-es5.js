(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-notification-notification-module"], {
    ...
    function srcAppModulesNotificationDetailNotificationDetailNotificationComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_shared_service_notificationSend_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          ...
          value: function getNotificationDetail() {
            ...
            this.notificationSendService.getDetailNotificatoin(this.notificationId).subscribe({
              next: function next(res) {
                ...
                _this6.notificationData = res;

                _this6.cdr.detectChanges();
              },
              error: function error(e) {
                _this6.notification.showError(e.error, "");
              }
            });
          }
        }]);
      ...
      DetailNotificationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: DetailNotificationComponent,
        selectors: [["app-detail-notification"]],
        decls: 26,
        vars: 8,
        consts: [[1, "contents__box", "contents__box--right"], [1, "section"], [1, "section-head"], [1, "section-content"], [1, "row"], [1, "col-xl-12"], [2, "font-weight", "600"], [1, "py-3"], [1, "label", "label-lg", "font-weight-bold", "label-light-success", "label-inline"], ["class", "label label-lg font-weight-bold label-light-primary label-inline", 4, "ngFor", "ngForOf"], ["class", "label label-lg font-weight-bold label-light-danger label-inline", 4, "ngFor", "ngForOf"], [2, "word-wrap", "break-word"], [1, "label", "label-lg", "font-weight-bold", "label-light-primary", "label-inline"], [1, "label", "label-lg", "font-weight-bold", "label-light-danger", "label-inline"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DetailNotificationComponent, [{
          ...
          return [{
            ...
            type: src_app_shared_service_notificationSend_service__WEBPACK_IMPORTED_MODULE_2__["NotificationSendService"]
          }, {
        ...
        _createClass(NewNotificationComponent, [{
          ...
          value: function getReceiver() {
            ...
            this.userService.getReceiverAll().subscribe(function (data) {
              ...
              _this7.filteredReceiverDataMulti.next(_this7.receiverData.slice());

              _this7.receiverMultiFilterCtrl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this7._onDestroy)).subscribe(function () {
                _this7.filterReceiverMulti();
              });
          ...
          value: function submitNotification() {
            ...
            if (this.newNotificationFG.valid) {
              ...
              this.notificationSendService.sendNotitication(this.newNotificationFG.value).subscribe({
                next: function next(res) {
                  if (res.status) {
                    _this9.notificationService.showSuccess("You sent notification!", "");
                  }
                },
                error: function error(e) {
                  _this9.notificationService.showError("Error while sending notification!", "");
                }
              });
            }
          }
    ...
    function srcAppModulesNotificationNotificationsNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function NotificationsComponent_div_0_ng_template_20_span_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function NotificationsComponent_div_0_ng_template_20_span_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(NotificationsComponent, [{
          ...
          value: function getPublisherNotifications() {
            ...
            this.notificationSendService.publisherNotificatoins().subscribe({
              ...
              error: function error(e) {
                _this10.notification.showError(e.error, "");
              }
            });
          }
        }, {
    ...
    function srcAppModulesNotificationSuperAdminNotificationsSuperAdminNotificationsComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function SuperAdminNotificationsComponent_div_0_ng_template_23_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SuperAdminNotificationsComponent_div_0_ng_template_23_Template_a_click_0_listener() {
            ...
            return ctx_r21.viewNotification(row_r20._key);
          });
      ...
      SuperAdminNotificationsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_5__["DatatableComponent"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_5__["DataTableColumnDirective"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_5__["DataTableColumnHeaderDirective"], _swimlane_ngx_datatable__WEBPACK_IMPORTED_MODULE_5__["DataTableColumnCellDirective"], ng_inline_svg__WEBPACK_IMPORTED_MODULE_6__["InlineSVGDirective"]],
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["DatePipe"]],
