(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-dynamic-api-dynamic-api-module"], {
            ...
            if (row.selectedOption === 'one') {
              if (row.subid !== 'never') {
                if (row.subidKey !== 'never') {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "?date=YYYY-MM-DD&subid=").concat(row.subidKey);
                } else {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "?date=YYYY-MM-DD&subid=SUBIDKEY");
                }
              } else {
              ...
              if (row.subid !== 'never') {
                if (row.subidKey !== 'never') {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "?start_date=YYYY-MM-DD&end_date=YYYY-MM-DD&subid=").concat(row.subidKey);
                } else {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "?start_date=YYYY-MM-DD&end_date=YYYY-MM-DD&subid=SUBIDKEY");
                }
              } else {
              ...
              if (row.subid !== 'never') {
                if (row.subidKey !== 'never') {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "&subid=").concat(row.subidKey);
                } else {
                  dynamicAPILink = "http://api.nextsys.io/api/dynamicAPI/uri/".concat(apiId, "&subid=SUBIDKEY");
                }
              } else {
    ...
    function srcAppModulesDynamicApiDynamicApiCreateDynamicApiCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function DynamicApiCreateComponent_form_0_mat_radio_button_48_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DynamicApiCreateComponent_form_0_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function DynamicApiCreateComponent_form_0_Template_mat_select_selectionChange_27_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r9.onSubidChange($event);
          });
        ...
        _createClass(DynamicApiCreateComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dynamicAPIFG = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
              ...
              subidKey: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]({
                value: '',
                disabled: true
              }),
          ...
          key: "onSubidChange",
          value: function onSubidChange(event) {
            var subidKeyControl = this.dynamicAPIFG.get('subidKey');
    ...
    function srcAppModulesDynamicApiDynamicApiUpdateDynamicApiUpdateComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function DynamicApiUpdateComponent_form_0_mat_radio_button_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-radio-button", 30);
      ...
      function DynamicApiUpdateComponent_form_0_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectionChange", function DynamicApiUpdateComponent_form_0_Template_mat_select_selectionChange_27_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8);
      ...
      var DynamicApiUpdateComponent = /*#__PURE__*/function () {
        ...
        _createClass(DynamicApiUpdateComponent, [{
          ...
          key: "onSubidChange",
          value: function onSubidChange(event) {
            var subidKeyControl = this.dynamicAPIEditFG.get('subidKey');
