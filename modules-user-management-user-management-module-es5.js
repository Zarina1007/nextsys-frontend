(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-user-management-user-management-module"], {
    ...
    function node_modulesNgMultiselectDropdown__ivy_ngcc__Fesm2015NgMultiselectDropdownJs(module, __webpack_exports__, __webpack_require__) {
      ...
      function MultiSelectComponent_span_4_Template(rf, ctx) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("", item_r8.text, "\xA0");
        }
      }
      ...
      MultiSelectComponent.ɵfac = function MultiSelectComponent_Factory(t) {
        return new (t || MultiSelectComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ListFilterPipe), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]));
      };
    ...
    /***/
    function node_modulesNgMultiselectDropdownNode_modulesTslibTslibEs6Js(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function node_modulesNgSelect2__ivy_ngcc__Fesm2015NgSelect2Js(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @angular/common */
      "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js"); /// <reference types="select2" />
        ...
        _createClass(NgSelect2Component, [{
          ...
          value: function ngAfterViewInit() {
            ...
            this.element.on('select2:select select2:unselect', function (e) {
              ...
              var newValue = _this6.element.val();

              _this6.valueChanged.emit(newValue);

              _this6.propagateChange(newValue);
            });
          }
        }, {
          key: "ngOnDestroy",
          ...
          value: function initPlugin() {
            ...
            if (options.matcher) {
              jQuery.fn.select2.amd.require(['select2/compat/matcher'], function (oldMatcher) {
                ...
                _this7.element.select2(options);

                if (typeof _this7.value !== 'undefined') {
                  _this7.setElementValue(_this7.value);
                }
              });
            } else {
      ...
      NgSelect2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgSelect2Component, [{
      ...
      NgSelect2Module.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: NgSelect2Module
      });
      NgSelect2Module.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](NgSelect2Module, {
          declarations: function declarations() {
            return [NgSelect2Component];
          },
          imports: function imports() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NgSelect2Module, [{
        ...
        _createClass(ValidateEqualDirective, [{
          ...
          value: function validate(selfControl) {
            ...
            this.valueChangesSub = otherControl.valueChanges.subscribe(function (otherControlValue) {
              if (!_this8.isEqual(selfControlValue, otherControlValue) && (selfControl.touched || selfControl.dirty)) {
    ...
    function node_modulesNgxDeviceDetector__ivy_ngcc__Fesm2015NgxDeviceDetectorJs(module, __webpack_exports__, __webpack_require__) {
        ...
        _createClass(DeviceDetectorService, [{
          ...
          value: function setDeviceInfo() {
            ...
            mappings.forEach(function (mapping) {
              _this9[mapping.prop] = Object.keys(Constants[mapping["const"]]).reduce(function (obj, item) {
                if (Constants[mapping["const"]][item] === 'device') {
                  // hack for iOS 13 Tablet
                  if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["isPlatformBrowser"])(_this9.platformId) && (!!_this9.reTree.test(_this9.userAgent, TABLETS_RE['iPad']) || navigator.platform === 'MacIntel' && navigator.maxTouchPoints > 1)) {
                    obj[Constants[mapping["const"]][item]] = 'iPad';
                    return Object;
                  }
                }

                obj[Constants[mapping["const"]][item]] = _this9.reTree.test(ua, Constants["".concat(mapping["const"], "_RE")][item]);
                return obj;
              }, {});
            });
            mappings.forEach(function (mapping) {
              _this9[mapping.prop] = Object.keys(Constants[mapping["const"]]).map(function (key) {
                ...
                if (mapping.prop === 'device' && previousValue === Constants[mapping["const"]].ANDROID) {
                  ...
                  return _this9[mapping.prop][currentValue] ? currentValue : previousValue;
                } else {
                  return previousValue === Constants[mapping["const"]].UNKNOWN && _this9[mapping.prop][currentValue] ? currentValue : previousValue;
                }
          ...
          value: function isMobile() {
            ...
            var match = Object.keys(MOBILES_RE).find(function (mobile) {
              return _this10.reTree.test(userAgent, MOBILES_RE[mobile]);
            });
            return !!match;
          }
          /**
          ...
          value: function isTablet() {
            ...
            var match = Object.keys(TABLETS_RE).find(function (mobile) {
              return !!_this11.reTree.test(userAgent, TABLETS_RE[mobile]);
            });
            return !!match;
          }
          /**
      ...
      DeviceDetectorService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        ...
        factory: function factory(t) {
          return DeviceDetectorService.ɵfac(t);
        },
        providedIn: 'root'
      });
      DeviceDetectorService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["defineInjectable"])({
        factory: function DeviceDetectorService_Factory() {
          return new DeviceDetectorService(Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["inject"])(_angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"]));
        },
        token: DeviceDetectorService,
        providedIn: "root"
      });
    ...
    function srcAppModulesUserManagementEditUsersAddTagAddTagComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function AddTagComponent_mat_error_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_mat_error_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_mat_error_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_mat_error_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_ng_multiselect_dropdown_41_Template(rf, ctx) {
        if (rf & 1) {
          var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ng-multiselect-dropdown", 26);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_ng_multiselect_dropdown_41_Template_ng_multiselect_dropdown_ngModelChange_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r12.handleBrowser($event);
          });
      ...
      function AddTagComponent_mat_error_42_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_ng_multiselect_dropdown_52_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ng-multiselect-dropdown", 27);
        }

        if (rf & 2) {
          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Device")("settings", ctx_r7.singleDeviceDropdownSettings)("data", ctx_r7.devices)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](4, _c0, ctx_r7.submitted && ctx_r7.tagFG.controls["device"].errors));
        }
      }

      function AddTagComponent_mat_error_53_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_ng_multiselect_dropdown_64_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ng-multiselect-dropdown", 28);
        }

        if (rf & 2) {
          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Browser Version")("settings", ctx_r9.singleVersionDropdownSettings)("data", ctx_r9.browserVersions)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](4, _c0, ctx_r9.submitted && ctx_r9.tagFG.controls["browserVersion"].errors));
        }
      }

      function AddTagComponent_mat_error_65_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function AddTagComponent_ng_multiselect_dropdown_75_Template(rf, ctx) {
        if (rf & 1) {
          var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ng-multiselect-dropdown", 29);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelect", function AddTagComponent_ng_multiselect_dropdown_75_Template_ng_multiselect_dropdown_onSelect_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r14.onItemSelect($event);
          })("onSelectAll", function AddTagComponent_ng_multiselect_dropdown_75_Template_ng_multiselect_dropdown_onSelectAll_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

            var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r16.onSelectAll($event);
          });
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Country")("settings", ctx_r11.singleDropdownSettings)("data", ctx_r11.countries);
        }
      }
      ...
      var AddTagComponent = /*#__PURE__*/function () {
        function AddTagComponent(activeModal, userManagementService, fb, sS) {
          ...
          this.defaultBrowserStatusVal = "Allowed";
          this.defaultDeviceStatusVal = "Allowed";
          this.defaultVersionStatusVal = "Allowed";
          this.defaultCountryStatusVal = "Allowed";
          this.browsers = [];
          this.devices = [];
        ...
        _createClass(AddTagComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.edgeVersions = [{
              id: "Edge - 88.0.705.18",
              name: "Edge - 88.0.705.18"
            }, {
              id: "Edge - 89.0.774.18",
              name: "Edge - 89.0.774.18"
            }, {
              id: "Edge - 90.0.818.8",
              name: "Edge - 90.0.818.8"
            }, {
              id: "Edge - 91.0.864.11",
              name: "Edge - 91.0.864.11"
            }, {
              id: "Edge - 92.0.902.9",
              name: "Edge - 92.0.902.9"
            }, {
              id: "Edge - 93.0.961.11",
              name: "Edge - 93.0.961.11"
            }, {
              id: "Edge - 94.0.992.9",
              name: "Edge - 94.0.992.9"
            }, {
              id: "Edge - 95.0.1020.9",
              name: "Edge - 95.0.1020.9"
            }, {
              id: "Edge - 96.0.1054.8",
              name: "Edge - 96.0.1054.8"
            }, {
              id: "Edge - 97.0.1072.21",
              name: "Edge - 97.0.1072.21"
            }, {
              id: "Edge - 98.0.1108.23",
              name: "Edge - 98.0.1108.23"
            }, {
              id: "Edge - 99.0.1150.11",
              name: "Edge - 99.0.1150.11"
            }, {
              id: "Edge - 100.0.1185.10",
              name: "Edge - 100.0.1185.10"
            }, {
              id: "Edge - 101.0.1210.10",
              name: "Edge - 101.0.1210.10"
            }, {
              id: "Edge - 102.0.1245.7",
              name: "Edge - 102.0.1245.7"
            }];
            this.operaVersions = [{
              id: "Opera - 12.15",
              name: "Opera - 12.15"
            ...
            this.edgeVersions.map(function (edge) {
              _this12.versionTempList.push(edge);
            });
            this.operaVersions.map(function (opera) {
              _this12.versionTempList.push(opera);
            }); //Chrome Version List Get

            this.userManagementService.GetChromeBrowserVersion().subscribe(function (res) {
              var versionsChromeData = res;
              versionsChromeData.map(function (version) {
                _this12.versionTempList.push({
                  "id": "Chrome - " + version.version,
                  "name": "Chrome - " + version.version
                });
              });
              _this12.browserVersions = _this12.versionTempList;
            }); //FireFox Version List Get

            this.userManagementService.GetFirefoxBrowserVersion().subscribe(function (res) {
              for (var i in res) {
                _this12.versionTempList.push({
                  "id": "FireFox - " + i,
                  "name": "FireFox - " + i
            ...
            this.countries = [{
              ...
              id: 'Korea, Democratic People\'S Republic o'
            }, {
              ...
              id: 'South Georgia and the South Sandwich Isla'
            }, {
              name: 'Spain',
              id: 'Spain'
            }, {
          ...
          value: function handleSubmit() {
            ...
            if (this.tagFG.valid) {
              this.userManagementService.addTag(this.tagFG.value).subscribe(function (x) {
                ...
                _this13.sS.info('Added a new tag');

                _this13.activeModal.close(x);
              });
            }
          }
        }, {
          key: "handleBrowser",
          value: function handleBrowser(event) {
            if (event[0].name == "ANY") {
          ...
          key: "changeSubLimit",
          value: function changeSubLimit(item) {
            var checkLimit = item.toString().includes("-");

            if (checkLimit) {
              var tempLimit = item.split('-');
      ...
      AddTagComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 81,
        vars: 39,
        consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [1, "modal-body"], [1, "example-container", 3, "formGroup"], [1, "row"], [1, "col-md-6"], ["type", "text", "matInput", "", "formControlName", "name", "placeholder", "Name"], [4, "ngIf"], ["type", "text", "matInput", "", "formControlName", "company", "placeholder", "Company"], ["type", "text", "matInput", "", "formControlName", "advertiser", "placeholder", "Advertiser"], ["type", "text", "matInput", "", "formControlName", "subId", "placeholder", "SubId", 3, "ngModelChange"], ["type", "text", "matInput", "", "formControlName", "limit", "placeholder", "Limit", 3, "ngModel"], ["formControlName", "browserStatus", 3, "data", "width", "ngModel", "placeholder", "ngModelChange"], [1, "form-group"], ["formControlName", "browser", 3, "placeholder", "settings", "data", "ngClass", "ngModelChange", 4, "ngIf"], ["formControlName", "deviceStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "device", 3, "placeholder", "settings", "data", "ngClass", 4, "ngIf"], ["formControlName", "browserVersionStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "browserVersion", 3, "placeholder", "settings", "data", "ngClass", 4, "ngIf"], ["formControlName", "countryStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "country", 3, "placeholder", "settings", "data", "onSelect", "onSelectAll", 4, "ngIf"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], ["formControlName", "browser", 3, "placeholder", "settings", "data", "ngClass", "ngModelChange"], ["formControlName", "device", 3, "placeholder", "settings", "data", "ngClass"], ["formControlName", "browserVersion", 3, "placeholder", "settings", "data", "ngClass"], ["formControlName", "country", 3, "placeholder", "settings", "data", "onSelect", "onSelectAll"]],
        template: function AddTagComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_Template_input_ngModelChange_24_listener($event) {
              return ctx.changeSubLimit($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_Template_ng_select2_ngModelChange_37_listener($event) {
              return ctx.defaultBrowserStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](40, "Browser");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](41, AddTagComponent_ng_multiselect_dropdown_41_Template, 1, 6, "ng-multiselect-dropdown", 16);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](42, AddTagComponent_mat_error_42_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](47, "Device Allow");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](48, "ng-select2", 17);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_Template_ng_select2_ngModelChange_48_listener($event) {
              return ctx.defaultDeviceStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](51, "Device");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](52, AddTagComponent_ng_multiselect_dropdown_52_Template, 1, 6, "ng-multiselect-dropdown", 18);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](53, AddTagComponent_mat_error_53_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](59, "Browser Allow");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](60, "ng-select2", 19);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_Template_ng_select2_ngModelChange_60_listener($event) {
              return ctx.defaultVersionStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](63, "Browser Version");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](64, AddTagComponent_ng_multiselect_dropdown_64_Template, 1, 6, "ng-multiselect-dropdown", 20);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](65, AddTagComponent_mat_error_65_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](70, "Country Allow");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](71, "ng-select2", 21);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function AddTagComponent_Template_ng_select2_ngModelChange_71_listener($event) {
              return ctx.defaultCountryStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](75, AddTagComponent_ng_multiselect_dropdown_75_Template, 1, 3, "ng-multiselect-dropdown", 22);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddTagComponent_Template_button_click_77_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AddTagComponent_Template_button_click_79_listener() {
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultDeviceStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](33, _c0, ctx.submitted && ctx.tagFG.controls["deviceStatus"].errors));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultVersionStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](35, _c0, ctx.submitted && ctx.tagFG.controls["browserVersionStatus"].errors));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultCountryStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](37, _c0, ctx.submitted && ctx.tagFG.controls["countryStatus"].errors));
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L2VkaXQtdXNlcnMvYWRkLXRhZy9hZGQtdGFnLmNvbXBvbmVudC5zY3NzIn0= */"]
      });
      /*@__PURE__*/
    ...
    /***/
    function srcAppModulesUserManagementEditUsersEditTagEditTagComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      function EditTagComponent_mat_error_12_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_42_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_53_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditTagComponent_mat_error_65_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      var EditTagComponent = /*#__PURE__*/function () {
        function EditTagComponent(activeModal, userManagementService, fb, sS) {
        ...
        _createClass(EditTagComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.userManagementService.getTag(this.data.tagKey).subscribe(function (res) {
              _this14.tempCountrySelected.push({
                id: res['country'],
                name: res['country']
              });

              _this14.countrySelected = _this14.tempCountrySelected; //version

              _this14.tempVersionSelected.push({
                id: res['browserVersion'],
                name: res['browserVersion']
              });

              _this14.versionSelected = _this14.tempVersionSelected; //device

              _this14.tempDeviceSelected.push({
                id: res['device'],
                name: res['device']
              });

              _this14.deviceSelected = _this14.tempDeviceSelected; //browser

              _this14.tempBrowserSelected.push({
                id: res['browser'],
                name: res['browser']
              });

              _this14.browserSelected = _this14.tempBrowserSelected;

              _this14.tagFG.setValue({
                name: res['name'],
                company: res['company'],
                advertiser: res['advertiser'],
                limit: res['limit'],
                browserStatus: res['browserStatus'],
                browser: _this14.browserSelected,
                deviceStatus: res['deviceStatus'],
                device: _this14.deviceSelected,
                browserVersionStatus: res['browserVersionStatus'],
                browserVersion: _this14.versionSelected,
                countryStatus: res['countryStatus'],
                country: _this14.countrySelected,
                subId: res['subId']
              });

              _this14.limitValue = res['limit'];
            });
            this.tagFG = this.fb.group({
              name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
              company: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required),
            ...
            this.edgeVersions.map(function (edge) {
              _this14.versionTempList.push(edge);
            });
            this.operaVersions.map(function (opera) {
              _this14.versionTempList.push(opera);
            }); //Chrome Version List Get

            this.userManagementService.GetChromeBrowserVersion().subscribe(function (res) {
              var versionsChromeData = res;
              versionsChromeData.map(function (version) {
                _this14.versionTempList.push({
                  "id": "Chrome - " + version.version,
                  "name": "Chrome - " + version.version
                });
              });
              _this14.browserVersions = _this14.versionTempList;
            }); //FireFox Version List Get
          ...
          value: function handleUpdateSubmit() {
            ...
            if (this.tagFG.valid) {
              this.userManagementService.updateTag(this.data.tagKey, this.tagFG.value).subscribe(function (x) {
                console.log(x);

                _this15.sS.info('Updated a tag');
          ...
          value: function handleBrowser(event) {
            if (event[0].name == "ANY") {
              this.browserVersions = this.browserVersions;
            } else {
              this.browserVersions = this.versionTempList.filter(function (version) {
                return version.name.toString().includes(event[0].name);
              });
      ...
      EditTagComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 81,
        vars: 56,
        consts: [[1, "modal-header"], [1, "modal-title"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [1, "modal-body"], [1, "example-container", 3, "formGroup"], [1, "row"], [1, "col-md-6"], ["type", "text", "matInput", "", "formControlName", "name", "placeholder", "Name"], [4, "ngIf"], ["type", "text", "matInput", "", "formControlName", "company", "placeholder", "Company"], ["type", "text", "matInput", "", "formControlName", "advertiser", "placeholder", "Advertiser"], ["type", "text", "matInput", "", "formControlName", "subId", "placeholder", "SubId", 3, "ngModelChange"], ["type", "text", "matInput", "", "formControlName", "limit", "placeholder", "Limit", 3, "ngModel"], ["formControlName", "browserStatus", 3, "data", "width", "ngModel", "placeholder", "ngModelChange"], [1, "form-group"], ["formControlName", "browser", 3, "placeholder", "settings", "data", "ngClass", "ngModelChange"], ["formControlName", "deviceStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "device", 3, "placeholder", "settings", "data", "ngClass"], ["formControlName", "browserVersionStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "browserVersion", 3, "placeholder", "settings", "data", "ngClass"], ["formControlName", "countryStatus", 3, "data", "width", "ngModel", "placeholder", "ngClass", "ngModelChange"], ["formControlName", "country", 3, "placeholder", "settings", "data", "onSelect", "onSelectAll"], [1, "modal-footer"], ["type", "button", 1, "btn", "btn-secondary", 3, "click"], ["type", "button", 1, "btn", "btn-primary", 3, "click"]],
        template: function EditTagComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTagComponent_Template_button_click_3_listener() {
              return ctx.activeModal.dismiss("Cross click");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_input_ngModelChange_24_listener($event) {
              return ctx.changeSubLimit($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_ng_select2_ngModelChange_37_listener($event) {
              return ctx.defaultBrowserStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_ng_multiselect_dropdown_ngModelChange_41_listener($event) {
              return ctx.handleBrowser($event);
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](42, EditTagComponent_mat_error_42_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_ng_select2_ngModelChange_48_listener($event) {
              return ctx.defaultDeviceStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](52, "ng-multiselect-dropdown", 18);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](53, EditTagComponent_mat_error_53_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](59, "Browser Version Allow");

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](60, "ng-select2", 19);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_ng_select2_ngModelChange_60_listener($event) {
              return ctx.defaultVersionStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](64, "ng-multiselect-dropdown", 20);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](65, EditTagComponent_mat_error_65_Template, 2, 0, "mat-error", 9);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function EditTagComponent_Template_ng_select2_ngModelChange_71_listener($event) {
              return ctx.defaultCountryStatusVal = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](75, "ng-multiselect-dropdown", 22);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onSelect", function EditTagComponent_Template_ng_multiselect_dropdown_onSelect_75_listener($event) {
              return ctx.onItemSelect($event);
            })("onSelectAll", function EditTagComponent_Template_ng_multiselect_dropdown_onSelectAll_75_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTagComponent_Template_button_click_77_listener() {
              return ctx.activeModal.close();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditTagComponent_Template_button_click_79_listener() {
              return ctx.handleUpdateSubmit();
            });
          ...
          if (rf & 2) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Browser")("settings", ctx.singleBrowserDropdownSettings)("data", ctx.browsers)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](44, _c0, ctx.submitted && ctx.tagFG.controls["browser"].errors));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultDeviceStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](46, _c0, ctx.submitted && ctx.tagFG.controls["deviceStatus"].errors));

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Device")("settings", ctx.singleDeviceDropdownSettings)("data", ctx.devices)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](48, _c0, ctx.submitted && ctx.tagFG.controls["device"].errors));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultVersionStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](50, _c0, ctx.submitted && ctx.tagFG.controls["browserVersionStatus"].errors));

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Browser Version")("settings", ctx.singleVersionDropdownSettings)("data", ctx.browserVersions)("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](52, _c0, ctx.submitted && ctx.tagFG.controls["browserVersion"].errors));
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("data", ctx.statusList)("width", "100%")("ngModel", ctx.defaultCountryStatusVal)("placeholder", "Select...")("ngClass", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpureFunction1"](54, _c0, ctx.submitted && ctx.tagFG.controls["countryStatus"].errors));

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("placeholder", "Select Country")("settings", ctx.singleDropdownSettings)("data", ctx.countries);
          }
        },
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatFormField"], _angular_material_input__WEBPACK_IMPORTED_MODULE_6__["MatInput"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"], ng_select2__WEBPACK_IMPORTED_MODULE_8__["NgSelect2Component"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_9__["MultiSelectComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgClass"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_5__["MatError"]],
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L2VkaXQtdXNlcnMvZWRpdC10YWcvZWRpdC10YWcuY29tcG9uZW50LnNjc3MifQ== */"]
      });
      /*@__PURE__*/
    ...
    function srcAppModulesUserManagementEditUsersEditUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_password_reset_user_password_reset_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _add_tag_add_tag_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-tag/add-tag.component */
      "./src/app/modules/user-management/edit-users/add-tag/add-tag.component.ts");
      /* harmony import */


      var _edit_tag_edit_tag_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      function EditUsersComponent_mat_error_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditUsersComponent_mat_error_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditUsersComponent_mat_error_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function EditUsersComponent_mat_header_cell_45_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditUsersComponent_mat_cell_46_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditUsersComponent_mat_header_cell_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_49_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_51_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_52_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_54_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_55_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_57_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_58_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_60_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_61_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_63_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_64_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_66_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_67_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function EditUsersComponent_mat_header_cell_69_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function EditUsersComponent_mat_cell_70_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditUsersComponent_mat_cell_70_Template_button_click_1_listener() {
            ...
            return ctx_r33.openEditTagDialog(element_r32._key);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditUsersComponent_mat_cell_70_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r34);
            ...
            return ctx_r35.deleteTag(element_r32._key);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditUsersComponent_mat_cell_70_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r34);
            ...
            return ctx_r36.handleSubIdList(ctx_r36.userId, element_r32._key);
          });
      ...
      function EditUsersComponent_mat_header_row_71_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function EditUsersComponent_mat_row_72_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var EditUsersComponent = /*#__PURE__*/function () {
        function EditUsersComponent(userManagementService, authService, route, sS, modalService, router) {
        ...
        _createClass(EditUsersComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.route.snapshot.params.id) {
              this.userManagementService.getUser(this.route.snapshot.params.id).subscribe(function (x) {
                _this16.user = x;
                _this16.tags.data = x.tags;
                _this16.tempTag = x.tags;
                _this16.tempTagId = x.tagsId;

                _this16.userProfileFG.patchValue(x);
              });
            } else {
          ...
          key: "onProfileSubmit",
          value: function onProfileSubmit($event) {
            var _this17 = this;
            ...
            if (this.userProfileFG.valid) {
              ...
              this.userManagementService.updateUser(this.user).subscribe(function (x) {
                _this17.sS.info('user profile updated');
              });
            }
          }
        }, {
          ...
          value: function openPasswordResetDialog() {
            var modalRef = this.modalService.open(_user_password_reset_user_password_reset_component__WEBPACK_IMPORTED_MODULE_2__["UserPasswordResetComponent"], {
              size: 'sm'
            });
          ...
          value: function openAddTagDialog() {
            ...
            var modalRef = this.modalService.open(_add_tag_add_tag_component__WEBPACK_IMPORTED_MODULE_3__["AddTagComponent"], {
              size: 'lg'
            });
            modalRef.componentInstance.data = {};
            modalRef.result.then(function (c) {
              var tags = _this18.user.tags || [];
              var tagsId = _this18.user.tagsId || [];
              tags.push(c);
              tagsId.push(c._key);
              _this18.user.tagsId = tagsId;
              _this18.tags.data = tags;

              _this18.userManagementService.updateUser(_this18.user).subscribe(function (x) {});
            });
          }
        }, {
          key: "deleteTag",
          value: function deleteTag(id) {
            ...
            if (window.confirm('Do you want to go ahead?')) {
              this.userManagementService.deleteTag(id).subscribe(function (res) {
                _this19.tempTag = _this19.tempTag.filter(function (tag) {
                  return tag._key != id;
                });
                _this19.tags.data = _this19.tempTag;
              });
            }
          }
        }, {
          key: "openEditTagDialog",
          value: function openEditTagDialog(tagKey) {
            var _this20 = this;

            var modalRef = this.modalService.open(_edit_tag_edit_tag_component__WEBPACK_IMPORTED_MODULE_4__["EditTagComponent"], {
              size: 'lg'
            });
            modalRef.componentInstance.data = {
              tagKey: tagKey
            ...
            modalRef.result.then(function (c) {
              var tags = _this20.user.tags || [];
              var tagsId = _this20.user.tagsId || [];
              var uptag = tags.filter(function (tag) {
                return tag._key != c._key;
              });
              uptag.push(c);
              _this20.user.tagsId = tagsId;
              _this20.tags.data = uptag;

              _this20.userManagementService.updateUser(_this20.user).subscribe(function (x) {});
            });
          ...
          key: "handleSubIdList",
          value: function handleSubIdList(userId, tagKey) {
      ...
      EditUsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function EditUsersComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function EditUsersComponent_Template_form_submit_8_listener($event) {
              return ctx.onProfileSubmit($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditUsersComponent_Template_button_click_25_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EditUsersComponent_Template_button_click_36_listener() {
        ...
        styles: [".warning-text[_ngcontent-%COMP%] {\n  color: #F00;\n}\n\n.list-group[_ngcontent-%COMP%]   .list-group-item[_ngcontent-%COMP%] {\n  cursor: pointer;\n}\n\n.example-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  max-height: 300px;\n  min-width: 300px;\n}\n\n.mat-table[_ngcontent-%COMP%] {\n  overflow: auto;\n  max-height: 300px;\n}\n\n.example[_ngcontent-%COMP%]   .example-preview[_ngcontent-%COMP%] {\n  min-height: 165px;\n  padding: 0 !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/
    ...
    /***/
    function srcAppModulesUserManagementEditUsersHistoryDetailHistoryDetailComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _user_management_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../../user-management.service */
      "./src/app/modules/user-management/user-management.service.ts");
      /* harmony import */
      ...
      function HistoryDetailComponent_mat_header_cell_12_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function HistoryDetailComponent_mat_cell_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function HistoryDetailComponent_mat_header_cell_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function HistoryDetailComponent_mat_cell_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function HistoryDetailComponent_mat_header_cell_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function HistoryDetailComponent_mat_cell_19_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function HistoryDetailComponent_mat_header_cell_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function HistoryDetailComponent_mat_cell_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function HistoryDetailComponent_mat_header_cell_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function HistoryDetailComponent_mat_cell_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function HistoryDetailComponent_mat_header_row_26_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function HistoryDetailComponent_mat_row_27_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-row");
        }
      }

      var HistoryDetailComponent = /*#__PURE__*/function () {
        function HistoryDetailComponent(userManagementService, authService, route, sS, modalService, router) {
        ...
        _createClass(HistoryDetailComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.userManagementService.getHistory(this.getTagKey, this.getSubId).subscribe(function (resHistory) {
              _this21.statics.data = resHistory;
            });
          }
        }]);
      ...
      HistoryDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L2VkaXQtdXNlcnMvaGlzdG9yeS1kZXRhaWwvaGlzdG9yeS1kZXRhaWwuY29tcG9uZW50LnNjc3MifQ== */"]
      });
      /*@__PURE__*/
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HistoryDetailComponent, [{
          ...
          return [{
            type: _user_management_service__WEBPACK_IMPORTED_MODULE_2__["UserManagementService"]
          }, {
    ...
    /***/
    function srcAppModulesUserManagementEditUsersSubidsSubidsComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SubidsComponent", function () {
        return SubidsComponent;
      });
      /* harmony import */
      ...
      function SubidsComponent_mat_header_cell_12_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function SubidsComponent_mat_cell_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function SubidsComponent_mat_header_cell_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function SubidsComponent_mat_cell_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function SubidsComponent_mat_header_cell_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function SubidsComponent_mat_cell_19_Template(rf, ctx) {
        if (rf & 1) {
          var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SubidsComponent_mat_cell_19_Template_button_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
            ...
            return ctx_r12.requestTag(ctx_r12.tagKey, element_r11.subid, element_r11.limit);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SubidsComponent_mat_cell_19_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
            ...
            return ctx_r14.handleHistoryList(ctx_r14.tagKey, element_r11.subid);
          });
      ...
      function SubidsComponent_mat_header_row_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function SubidsComponent_mat_row_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-row");
        }
      }

      var SubidsComponent = /*#__PURE__*/function () {
        function SubidsComponent(userManagementService, authService, route, sS, modalService, router, deviceService) {
          _classCallCheck(this, SubidsComponent);
        ...
        _createClass(SubidsComponent, [{
          ...
          value: function ngOnInit() {
            ...
            if (this.route.snapshot.params.id) {
              this.userManagementService.getSubIds(this.userId, this.tagKey).subscribe(function (x) {
                _this22.subIds.data = x['tags'][0].subIds;
              });
            }
          ...
          key: "handleHistoryList",
          value: function handleHistoryList(tagKey, subid) {
            this.router.navigateByUrl('/user-management/tag-history/' + tagKey + '/subids/' + subid);
          }
        }, {
          key: "requestTag",
          value: function requestTag(tagKey, subid, limit) {
            var _this23 = this;

            this.userManagementService.RequestTag(tagKey, subid, limit, this.browserName, this.browserVersion, this.deviceType).subscribe(function (res) {
              if (res == "Allowed") {
                _this23.sS.success('Traffic Allowed');
              } else {
                _this23.sS.error('Traffic Not Allowed');
              }
            });
          }
        }, {
          key: "detectAgent",
          value: function detectAgent() {
      ...
      SubidsComponent.ɵfac = function SubidsComponent_Factory(t) {
        return new (t || SubidsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_user_management_service__WEBPACK_IMPORTED_MODULE_2__["UserManagementService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_auth_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_shared_service_snackbar_service__WEBPACK_IMPORTED_MODULE_5__["SnackbarService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModal"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_device_detector__WEBPACK_IMPORTED_MODULE_7__["DeviceDetectorService"]));
      };

      SubidsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SubidsComponent,
        selectors: [["app-subids"]],
        decls: 22,
        vars: 4,
        consts: [[1, "row"], [1, "col-xl-12"], [1, "card", "card-custom", "example", "example-compact", "gutter-b"], [1, "card-header"], [1, "card-title"], [1, "card-label"], [1, "card-body"], [1, "example-container", "mat-elevation-z8"], [3, "dataSource"], ["table", ""], ["matColumnDef", "subId"], [4, "matHeaderCellDef"], [4, "matCellDef"], ["matColumnDef", "limit"], ["matColumnDef", "action"], [4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], [1, "btn", "btn-sm", "btn-primary", "m-1", 3, "click"], [1, "btn", "btn-sm", "btn-info", "m-1", 3, "click"]],
        template: function SubidsComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        directives: [_angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTable"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatColumnDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRow"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRow"]],
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L2VkaXQtdXNlcnMvc3ViaWRzL3N1Ymlkcy5jb21wb25lbnQuc2NzcyJ9 */"]
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SubidsComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
            selector: 'app-subids',
    ...
    function srcAppModulesUserManagementEditUsersUserPasswordResetUserPasswordResetComponentTs(module, __webpack_exports__, __webpack_require__) {
          ...
          value: function handleSubmit() {
            ...
            if (this.passwordFG.valid) {
              ...
              this.userManagementService.resetPassword(id, password).subscribe(function (x) {
                _this24.sS.info('password has been reset');

                _this24.activeModal.close();
              });
            }
          }
        }]);
      ...
      UserPasswordResetComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L2VkaXQtdXNlcnMvdXNlci1wYXNzd29yZC1yZXNldC91c2VyLXBhc3N3b3JkLXJlc2V0LmNvbXBvbmVudC5zY3NzIn0= */"]
      });
      /*@__PURE__*/
    ...
    function srcAppModulesUserManagementRolesRolesComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function RolesComponent_tr_7_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 9);
        }
      }

      function RolesComponent_tr_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      RolesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 9,
        vars: 3,
        consts: [["mat-table", "", 1, "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "position"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "name"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]],
        ...
        directives: [_angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTable"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatColumnDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRow"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRow"]],
        styles: ["table[_ngcontent-%COMP%] {\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
      });
      /*@__PURE__*/
    ...
    function srcAppModulesUserManagementUserManagementRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _edit_users_edit_users_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./edit-users/edit-users.component */
      "./src/app/modules/user-management/edit-users/edit-users.component.ts");
      /* harmony import */


      var _edit_users_subids_subids_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./edit-users/subids/subids.component */
      "./src/app/modules/user-management/edit-users/subids/subids.component.ts");
      /* harmony import */


      var _edit_users_history_detail_history_detail_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./edit-users/history-detail/history-detail.component */
      "./src/app/modules/user-management/edit-users/history-detail/history-detail.component.ts");
    ...
    function srcAppModulesUserManagementUserManagementModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _user_management_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var ng_select2__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ng-select2 */
      "./node_modules/ng-select2/__ivy_ngcc__/fesm2015/ng-select2.js");
      /* harmony import */
      ...
      var _edit_users_edit_tag_edit_tag_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      /*! ./edit-users/edit-tag/edit-tag.component */
      "./src/app/modules/user-management/edit-users/edit-tag/edit-tag.component.ts");
      /* harmony import */


      var _edit_users_subids_subids_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./edit-users/subids/subids.component */
      "./src/app/modules/user-management/edit-users/subids/subids.component.ts");
      /* harmony import */


      var _edit_users_history_detail_history_detail_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./edit-users/history-detail/history-detail.component */
      "./src/app/modules/user-management/edit-users/history-detail/history-detail.component.ts");
      ...
      UserManagementModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_13__["MatTableModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__["MatFormFieldModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_12__["NgbModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_20__["MatIconModule"], _user_management_routing_module__WEBPACK_IMPORTED_MODULE_6__["UserManagementRoutingModule"], ng_select2__WEBPACK_IMPORTED_MODULE_21__["NgSelect2Module"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_22__["NgMultiSelectDropDownModule"].forRoot(), ng_validate_equal__WEBPACK_IMPORTED_MODULE_16__["ValidateEqualModule"]]]
      });
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserManagementModule, {
          ...
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_13__["MatTableModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_7__["MatInputModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_8__["MatFormFieldModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_9__["MatButtonModule"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_11__["MatSnackBarModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_10__["MatDialogModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_12__["NgbModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_20__["MatIconModule"], _user_management_routing_module__WEBPACK_IMPORTED_MODULE_6__["UserManagementRoutingModule"], ng_select2__WEBPACK_IMPORTED_MODULE_21__["NgSelect2Module"], ng_multiselect_dropdown__WEBPACK_IMPORTED_MODULE_22__["NgMultiSelectDropDownModule"], ng_validate_equal__WEBPACK_IMPORTED_MODULE_16__["ValidateEqualModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function srcAppModulesUserManagementUserManagementServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_service_tags_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./../../shared/service/tags.service */
      "./src/app/shared/service/tags.service.ts");

      var UserManagementService = /*#__PURE__*/function () {
        function UserManagementService(http, usersService, tagsService) {
        ...
        _createClass(UserManagementService, [{
          ...
          key: "getTag",
          value: function getTag(tagKey) {
            return this.tagsService.getOne(tagKey);
          }
        }, {
          key: "getHistory",
          value: function getHistory(tagKey, subId) {
          ...
          key: "updateTag",
          value: function updateTag(tagKey, tag) {
          ...
          key: "getSubIds",
          value: function getSubIds(userId, tagKey) {
            return this.tagsService.getSubIDs(userId, tagKey);
          }
        }, {
          key: "RequestTag",
          value: function RequestTag(tagKey, subId, limit, browserName, browserVersion, deviceType) {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserManagementService, [{
          ...
          return [{
            ...
            type: _shared_service_tags_service__WEBPACK_IMPORTED_MODULE_3__["TagsService"]
          }];
        }, null);
      })();
      /***/
    ...
    function srcAppModulesUserManagementUsersUsersComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function UsersComponent_mat_header_cell_12_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-header-cell");
      ...
      function UsersComponent_mat_cell_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-cell");
      ...
      function UsersComponent_mat_cell_22_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UsersComponent_mat_cell_22_Template_button_click_1_listener() {
            ...
            return ctx_r15.handleEditClick(element_r14._key);
          });
      ...
      function UsersComponent_mat_header_row_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-header-row");
        }
      }

      function UsersComponent_mat_row_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-row");
        }
      }
      ...
      var UsersComponent = /*#__PURE__*/function () {
        function UsersComponent(usersServie, cdr, router, route) {
        ...
        _createClass(UsersComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.subscritions.push(this.usersServie.getAll().subscribe(function (data) {
              console.log(data);
      ...
      UsersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 25,
        vars: 3,
        consts: [[1, "row"], [1, "col-xl-12"], [1, "card", "card-custom", "example", "example-compact", "gutter-b"], [1, "card-header"], [1, "card-title"], [1, "card-label"], [1, "card-body"], [1, "example-container", "mat-elevation-z8"], [3, "dataSource"], ["table", ""], ["matColumnDef", "fullname"], [4, "matHeaderCellDef"], [4, "matCellDef"], ["matColumnDef", "email"], ["matColumnDef", "stat"], ["matColumnDef", "action"], [4, "matHeaderRowDef"], [4, "matRowDef", "matRowDefColumns"], ["type", "button", 1, "btn", "btn-primary", 3, "click"]],
        ...
        directives: [_angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatTable"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatColumnDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCellDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRowDef"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatCell"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatHeaderRow"], _angular_material_table__WEBPACK_IMPORTED_MODULE_1__["MatRow"]],
        styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9zcmMvYXBwL21vZHVsZXMvdXNlci1tYW5hZ2VtZW50L3VzZXJzL3VzZXJzLmNvbXBvbmVudC5zY3NzIn0= */"]
      });
      /*@__PURE__*/
    ...
    function srcAppSharedServiceTagsServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var TagsService = /*#__PURE__*/function () {
        ...
        _createClass(TagsService, [{
          ...
          key: "getOne",
          value: function getOne(tagKey) {
            return this.http.get(API_TAGS_URL + "/".concat(tagKey));
          }
        }, {
          key: "getHistory",
          value: function getHistory(tagKey, subId) {
            return this.http.get(API_TAGS_URL + "/all-history" + "/".concat(tagKey) + "/".concat(subId));
          }
        }, {
          key: "deleteOne",
          value: function deleteOne(tagKey) {
          ...
          key: "update",
          value: function update(tagKey, tag) {
            return this.http.post(API_TAGS_URL + "/update-tag/".concat(tagKey), tag);
          }
        }, {
          key: "GetChrome",
          ...
          key: "getSubIDs",
          value: function getSubIDs(userId, tagKey) {
            return this.http.get("".concat(API_TAGS_URL, "/get_subids") + "/".concat(userId) + "/".concat(tagKey));
          }
        }, {
          key: "RequestTag",
          value: function RequestTag(tagKey, subid, limit, browserName, browserVersion, deviceType) {
            var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]().set('tag', tagKey).set('subid', subid).set('limit', limit).set('browserName', browserName).set('browserVersion', browserVersion).set('deviceType', deviceType);
            return this.http.get("".concat(API_TAGS_URL, "/history/go/"), {
              params: params
            });
          }
        }]);
    ...
    /***/
    function srcAppSharedServiceUsersServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UsersService = /*#__PURE__*/function () {
        ...
        _createClass(UsersService, [{
          ...
          key: "resetPassword",
          value: function resetPassword(userId, password) {
            return this.http.post("".concat(API_USERS_URL, "update_password/").concat(userId), {
              password: password
            });
          }
        }, {
